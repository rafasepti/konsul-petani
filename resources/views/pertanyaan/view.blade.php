                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col col-md-6">
                                {{-- <a href="{{ url('pertanyaan/create') }}" class="btn btn-success btn-sm float-right">
                                ...
                                @foreach($pertanyaan as $row)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a onclick="deleteConfirm(this); return false;" href="#" data-id="{{ $row->id_pertanyaan }}" class="btn btn-danger btn-circle">
