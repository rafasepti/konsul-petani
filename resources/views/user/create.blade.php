                ...
                <div class="card-header">Tambah User</div>
                  <div class="card-body">
                      ...
                      <form action="{{ url('/user/store') }}" method="post">
                          @csrf
                          <input class="form-control form-control-solid" id="id_kategori" name="id_kategori" type="hidden">
                          
                          <div class="mb-3"><label for="namelabel">Nama</label>
                            <input class="form-control form-control-solid" id="name" name="name" type="text" value="{{old('name')}}">
                          </div>

                          <div class="mb-3"><label for="emaillabel">Email</label>
                            <input class="form-control form-control-solid" id="email" name="email" type="text" value="{{old('email')}}">
                          </div>

                          <div class="mb-3"><label for="passwordlabel">Password</label>
                            <input class="form-control form-control-solid" id="password" name="password" type="password" value="{{old('password')}}">
                          </div>
