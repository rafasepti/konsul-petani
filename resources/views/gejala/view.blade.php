            ...
            <div class="col-xl-12 col-lg-12 col-sm-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col col-md-6"><b>Gejala Data</b></div>
                            ...
                            @if(count($gejala) > 0)
                                ...
                                @foreach($gejala as $row)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{url('gejala/edit',$row->id_gejala)}}" class="btn btn-success btn-circle">
                                                <i class="fas fa-edit"></i>
                                            </a>

                                            <a onclick="deleteConfirm(this); return false;" href="#" data-id="{{ $row->id_gejala }}" class="btn btn-danger btn-circle">
